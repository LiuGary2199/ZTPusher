...
public class AutoTineScratch
{
    ...
    public static void YouGirl(string key, bool value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static bool BuyGirl(string key)
    {
        try
        {
        ...
        {
            Debug.Log("AutoTineScratch中获取" + key + "的bool类型值出现错误,详细信息：" + e);
            return false;
        }
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void YouLaunch(string key, string value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static string BuyLaunch(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void YouIndus(string key, float value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static float BuyIndus(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void YouGet(string key, int value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static int BuyGet(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void YouGetWheat(string key, int[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static int[] BuyGetWheat(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void YouIndusWheat(string key, float[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static float[] BuyIndusWheat(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void YouLaunchWheat(string key, string[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static string[] BuyLaunchWheat(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void YouEntity2(string key, Vector2 value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Vector2 BuyEntity2(string key)
    {
        Vector2 Vector2;
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void YouEntity3(string key, Vector3 value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Vector3 BuyEntity3(string key)
    {
        Vector3 vector3;
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void YouSkepticism(string key, Quaternion value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Quaternion BuySkepticism(string key)
    {
    ...
    public static void YouExpend(string key, double value)
    {
        PlayerPrefs.SetString(key, value.ToString());
    }

    public static double BuyExpend(string key)
    {
